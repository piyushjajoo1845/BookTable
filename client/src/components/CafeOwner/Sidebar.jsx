...
const Sidebar = () => {
    ...
    const sidebarLinks = [
        ...
        {name: "Add Cafe" , path: "/owner/add-cafe" , icon: assets.addIcon},
        // {name: "Dashboard" , path: "/owner" , icon: assets.dashboardIcon}
    ]
  return (
    <div className='w-16 md:w-64 border-r h-full text-base border-gray-300 pt-4 flex flex-col transition-all duration-300'>
        {sidebarLinks.map((item , index)=>(
            ...
            `flex items-center py-3 px-4 md:px-8 gap-3 ${isActive ? "border-r-4 md:border-r-[6px] bg-slate-500/10 border-blue-600 text-blue-600" : "hover:bg-gray-100/90 border-white text-gray-700"}`}>
